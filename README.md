...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ckoq6fe.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ckoq6fe.containers.anotherwebservice.com/
...
```
git clone git@github.com:tpraxedes/container-ckoq6fe.git
cd container-ckoq6fe
```
...
```
docker attach container-ckoq6fe
```
